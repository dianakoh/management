...
<body>
	...
	<div id="content">
		...
		<section id="mainSection"> <section id="menu"
		...
		<form id="phoneBookUpdateform" action="phoneBook_UpdateProcess.jsp"
			onsubmit="return phoneBookUpdate_check();">
			<table border='2'>
				<tr>
					<td>이름</td>
					<td><input type="text" name="user_name" value="<%=userName%>" />
						<input type="text" name="number" size="40" value="<%=no%>"
						style="display: none;" /></td>
				</tr>

				<tr>
					<td>전화번호</td>
					<td><input type='text' size='20' name="user_phone"
						value="<%=userPhone%>" /></td>
				</tr>
				<tr>
					<td>생년월일</td>
					<td><input type='text' size='20' name="user_birth"
						value="<%=userBirth%>" /></td>
				</tr>

				<tr>
					<td>이메일</td>
					<td><input type='text' size='20' name="user_email"
						value="<%=userEmail%>" /></td>
				</tr>
			</table>

			<input type="submit" value="저장"> <input type="reset"
				value="취소" name="resetbtn" OnClick="javascript:history.back(-1)">
		</form>
		</section>
	</div>
</body>
